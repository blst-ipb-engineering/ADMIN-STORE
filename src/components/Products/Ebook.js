            ...
            <div className="product-list-admin-wrapper">
                ...
                <div className="product-list-display-wrapper">
                    ...
                    <div className="box-short-desc">
                        <Link to={`/dashboard/ebooks/${this.props.produk.id}/edit`}>
                            <span href={`/dashboard/ebooks/${this.props.produk.id}/edit`} target="_blank">{this.props.produk.name}</span>
                        </Link>
                ...
                <div className="icon-manage-product-wrapper" style={{ verticalAlign: 'top' }}>
                    <ul className="icon-manage-product">
                        <li>
                            <Link to={`/dashboard/ebooks/${this.props.produk.id}/edit`}>
                                <span href="http://localhost:3000/ebooks/edit" data-tip="Ubah">
                        ...
                        <li>
                            <Link to={`/dashboard/ebooks/${this.props.produk.id}/duplicate`}>
                                <span href="http://localhost:3000/ebooks/edit" data-tip="Duplikat">
